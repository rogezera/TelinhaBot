...
var dummy = {
    ...
    step: 1,
    name: 'dummy',
    textView: 'Total de %name% : %value%',
    textPlus: 'O total de %name% subiu. Novo total: %value%.',
    textMinus: 'O total de %name% caiu. Novo total: %value%.',
    textReset: 'O total de %name% foi resetado para %value%.',
    textValue: 'O total de %name% foi setado para %value%.',
    textLeaderboard: 'Ranking de %name% :',
    leaderboard: {},
    whitelist: {}
};
